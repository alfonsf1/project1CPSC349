...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-lock"> 
			</span>  Welcome <?php echo $userRow->username; ?> &nbsp; </span>
		  </a> 
        ...
        <div id="navbar" class="collapse navbar-collapse">
				...
				<form class="navbar-form navbar-right">
					<a href="index.php?refresh" class="btn btn-primary"">
				...
				<form class="navbar-form navbar-right">
					<a href="logout" class="btn btn-primary">
						<span class="glyphicon glyphicon-user"> LogOut <span class="glyphicon glyphicon-log-out"></span> </span>
					</a>
				</form>
    ...
    <div class="container">
      ...
      <div class="jumbotron" style="margin-top:60px;margin-right:-1em;margin-left:1em;">
        <h2> <span class="glyphicon glyphicon-list-alt"> </span> Personal Contact Book   
		
		  </h2>
		    <a class="btn btn-lg btn-primary" role="button" data-toggle="collapse" data-target="#main_content">
			 Show/Hide <span class="glyphicon glyphicon-menu-down"> </span> 
